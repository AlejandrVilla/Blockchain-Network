...
# and applications. Consists of two organizations with two
# peer each, and two node Raft ordering service.
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.example.com docker_orderer2.example.com docker_peer0.org1.example.com docker_peer1.org1.example.com docker_peer0.org2.example.com
